...
// setupLogging configures the logging system based on format preference
func setupLogging() {
...
// detectLogFormat automatically detects the appropriate log format based on environment
